q = ['What harsh truths do you prefer to ignore?',
     ...
     'How would humanity change if all humans’ life expectancy was significantly increased(let’s say toaround 500 years)?',
     ...
     'Some people believe that if life has no purpose, then there is no reason for living. While others think that if life has no purpose, that frees a person to find/create and follow their own personal purpose. Which is a more valid point of view or arthey both equally valid?',
     ...
     'ľ Know thyself is an ancient concept going back much further than Socrates and is at the root of much of philosophy. With that in mind, what are the most important things to learn about one’s self or is all self-knowledge equal?',
     ...
     'As more and more is being discovered about quantum physics, we become less and less able to comprehend the nature of reality. Is this something temporary and our minds will adapt and begin to understand this new reality or is it possible that the humans will soon reach their limits of comprehension? If it’s only temporary, is there is a limit to what the human mind can comprehend?', 'Ifwe are reaching our limits, how do we continue to study our reality?'
     ...
     'Is it possible that some animals are self-aware and think about their ability to think? How do you define consciousness?',
     ...
     'Would it be more frightening to discover that humans are the most advanced species in the universeor that we are far from being the most advanced species in the universe?', 'How would you define genius?'
     ...
     'Is the concept of ľyouĿ continuous or does past ľyouĿ continually fade into present and future ľyouĿ?',
     'In other words, what part of ľyouĿ sticks around over time considering that the atoms that make up your body are constantly being replaced and your memories are always changing?',
     ...
     'Is it be possible for humans to create something completely novel and new that is based on nothingthat previously existed? Or is human creativity just rearranging and building on previous ideas?'
     'If there existed a perfect clone of you, would it also be you? Would it act in exactly the same manneras you(like a mirror) or would it act differently? If it acted differently then would it still be you? At what point would it not be you?',
     ...
     'If it was discovered that personali ty traits were partly genetic and could be removed with gene therapy, would it be ethicalto edit out negative character traits that harm others like extreme aggression, compulsive lying, or cruelty?',
     ...
     'As people, we feel our moral obligation weaken with physical as well as emotional distance fromindividuals in need. For example, you’re more likely to help someone dying of hunger at your feet than someone dying of hunger in another country. How does this human trait of morality dependent on distance shape our world?',
     ...
     'Considering that the technology exists to enable a real democracy, would a true democracy(every single person can vote on every single legislation) be advantageousordetrimental?',
     ...
     'Is it right or wrong that everyone seems to be accustomed to the fact that all of humanity and most ofthe life on Earth could be wiped out at the whim of a handful of people?',
     ...
     'Was the agricultural revolution and the explosion of civilizations that came from it an overall goodthing for humans or a negative? In other words, would it have been better or worse for people to stayin small tribes?',
     ...
     'Assume that in the future there will be huge leaps in human augmentation. Given a scale from completely human to completmachine,  how far would you choose to augment yourself with robotics? What parts would you augment and why?',
     'If the transporters in Star Trek existed and you used it, your particles would be disassembled and then reassembled, do you die every single time? Are you ever alive at two places at once? Are you evercompletely dead?',
...
g = ['When you are old, what do you think children will ask you to tell stories about?',
     ...
     ' What’s the best / worst practical joke that you’ve played on someone or that wasplayed on you?',
     ...
     ' What ľold personĿ things do you do?',
     ...
     ' If you were given a PhD degree, but had no more knowledge of the subject of the degree besides what you have now, what degree would you want to be given toyou?',
     ...
     ' What’s your ľBack in my day, we…Ŀ?',
     ...
     ' If you could talk to animals and they would understand you, but you couldn’tunderstand them, what would you do with that power?',
     ...
     ' What seemingly innocent question makes you think ľIt’s a trap!Ŀ?',
     ...
     ' What do you think about when you hear the word ľclassyĿ?',
     ' What near future predictions do you have?',
     ' What do you need help with most often?',
     ' What piece of ľartĿ would you create if you had to pretend to be an artist and submit something to a gallery?',
     ...
     ' What’s your ľand then it got worseĿ story?',
     ...
     ' What product do you wish a company would make a ľsmartĿ version of?',
...
f = [' DO NOT BE AN IDIOT', 'He who has a why to live can bear almost any how.',
     ...
     'We have art in order not to die of the truth.', 'Insanity: doing the same thing over and over again and expecting different results.',
     ...
     "If you can't explain it simply, you don't understand it well enough.", "Love is a serious mental disease.", "Your silence gives consent.",
